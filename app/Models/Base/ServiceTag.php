...
class ServiceTag extends BaseModel
{
	...
	{
		return $this->belongsToMany(Project::class, 'project_service_tag_joint', Project::TAG_U_ID, Project::PROJECT_U_ID)
	...
	{
		return $this->belongsToMany(CheckIn::class, 'service_tag_check_in', CheckIn::SERVICE_TAG_U_ID, CheckIn::CHECK_IN_U_ID)
	...
	{
		return $this->belongsToMany(Blog::class, 'service_tags_blogs_joint', Blog::SERVICE_TAG_U_ID, Blog::BLOG_U_ID)
	...
	{
		return $this->belongsToMany(BusinessProfile::class, 'service_tags_business_profile_joint', BusinessProfile::TAG_U_ID, BusinessProfile::PROFILE_U_ID)
	...
	{
		return $this->belongsToMany(ServiceCategory::class, 'service_tags_service_category_joint', ServiceCategory::TAG_U_ID, ServiceCategory::CATEGORY_U_ID)
